      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 flex overflow-hidden">
          <div className="flex-1 overflow-auto p-6">
            ...
            {activeView === 'accounts' && <div className="text-center text-gray-500 mt-20">Accounts view coming soon</div>}
            {activeView === 'tasks' && <div className="text-center text-gray-500 mt-20">Tasks view coming soon</div>}
          </div>
